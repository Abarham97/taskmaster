...
public final class Task implements Model {
  ...
  private Task(String id, String title, String description, Temporal.DateTime dateCreated, State state, Team team, String teamName) {
    this.id = id;
    this.title = title;
  ...
  public static class Builder implements TitleStep, BuildStep {
    ...
    private Builder(String id, String title, String description, Temporal.DateTime dateCreated, State state, Team team, String teamName) {
      this.id = id;
      this.title = title;
      this.description = description;
      this.dateCreated = dateCreated;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String description, Temporal.DateTime dateCreated, State state, Team team, String teamName) {
